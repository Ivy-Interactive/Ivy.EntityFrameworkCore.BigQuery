    ...
    public class BigQueryDataReader : DbDataReader, IDbColumnSchemaGenerator
    {
        ...
        public override T GetFieldValue<T>(int ordinal)
        {
            ...
            try
            {
                ...
                if (BigQueryTypeHandlers.GeographyHandler is { } geoHandler && geoHandler.IsGeographyType(typeof(T)))
                {
                    if (geoHandler.TryConvertFromGeography(value, typeof(T), out var geometry) && geometry != null)
                    {
                        return (T)geometry;
                    }
